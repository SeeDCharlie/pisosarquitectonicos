"""
Django settings for pisosarquitectonicos project.
...
ROOT_URLCONF = 'pisosarquitectonicos.urls'
...
WSGI_APPLICATION = 'pisosarquitectonicos.wsgi.application'
